...
def task_create_reminder_for_user_one_hour(self, date: 'datetime', event_id: int):
    ...
    logger.info('create_reminder - timelimit: {0.timelimit!r}, delivery_info: {0.delivery_info!r}'.format(self.request))
...
def task_send_reminder_by_email(self, reminder_time: int, event_id: int):
    ...
    logger.info('timelimit: {0.timelimit!r}, delivery_info: {0.delivery_info!r}'.format(self.request))
